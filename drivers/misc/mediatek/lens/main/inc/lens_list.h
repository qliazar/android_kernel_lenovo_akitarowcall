...
#define CN3927E_HI556TXD_SetI2Cclient CN3927E_HI556TXD_SetI2Cclient_Main
#define CN3927E_HI556TXD_Ioctl CN3927E_HI556TXD_Ioctl_Main
#define CN3927E_HI556TXD_Release CN3927E_HI556TXD_Release_Main
#define CN3927E_HI556TXD_GetFileName CN3927E_HI556TXD_GetFileName_Main
extern int CN3927E_HI556TXD_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long CN3927E_HI556TXD_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int CN3927E_HI556TXD_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int CN3927E_HI556TXD_GetFileName(unsigned char *pFileName);

#define CN3927E_SC500CS_SetI2Cclient CN3927E_SC500CS_SetI2Cclient_Main
#define CN3927E_SC500CS_Ioctl CN3927E_SC500CS_Ioctl_Main
#define CN3927E_SC500CS_Release CN3927E_SC500CS_Release_Main
#define CN3927E_SC500CS_GetFileName CN3927E_SC500CS_GetFileName_Main
extern int CN3927E_SC500CS_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long CN3927E_SC500CS_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int CN3927E_SC500CS_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int CN3927E_SC500CS_GetFileName(unsigned char *pFileName);
