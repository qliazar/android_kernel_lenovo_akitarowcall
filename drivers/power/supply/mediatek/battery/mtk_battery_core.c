...
int get_use_month(struct mytime factory_time,struct mytime now_time)
{
...
int get_bat_maintain_mode(int month_used)
{
	...
	bm_err("BATTERY_MAINTAIN_MODE: %d \n",BATTERY_MAINTAIN_MODE);
...
int battery_update_routine(void *x)
{
	...
	gm.ui_soc = battery_main.BAT_CAPACITY;
