...
static struct hx9031a_addr_val_pair hx9031a_reg_init_list_hx9023e[] = {
    ...
    {RA_GLOBAL_CTRL0_0x00,             0x00}, //open dither
    {RA_PRF_CFG_0x02,                  0x16}, //重要！！此处修改后要同步修改宏定义 HX9031A_ODR_MS; 0x0f:50ms
    {RA_RANGE_7_0_0x0D,                0x44}, //range ch1 ch0 0.625p
    {RA_RANGE_9_8_0x0E,                0x00}, //range ch3 1.25p ch2 1.25pf
    {RA_AVG0_NOSR0_CFG_0x10,           0x11}, //ch0 osr 512 avg 1 warm 16.
    {RA_NOSR12_CFG_0x11,               0x24}, //ch2 osr 64; ch1 osr 512
    {RA_NOSR43_CFG_0x12,               0x12}, //ch3 osr 64
    {RA_AVG12_CFG_0x13,                0x00}, //ch1 and ch2 avg 1
    {RA_AVG34_CFG_0x14,                0x00}, //ch3 avg 1
    {RA_SAMPLE_NUM_7_0_0x1f,           0x39}, //sample frequency 0x42: 74K. 0x4B 62K, 0x37 57K
    {RA_INTEGRATION_NUM_7_0_0x21,      0x39}, //sample frequency 0x42: 74K. 0x4B 62K, 0x37 57K
    ...
    {RA_RAW_BL_RD_CFG_0x38,            0x0F}, //7:4 bl lp
    ...
    {RA_PROX_HIGH_DIFF_CFG_CH0_0_0x80, 0x05}, //high int 0x3FF*32
    {RA_PROX_HIGH_DIFF_CFG_CH0_1_0x81, 0x00},
    {RA_PROX_HIGH_DIFF_CFG_CH1_0_0x82, 0x05}, //high int 0x3FF*32
    {RA_PROX_HIGH_DIFF_CFG_CH1_1_0x83, 0x00},
    {RA_PROX_HIGH_DIFF_CFG_CH2_0_0x84, 0xFF}, //high int 0x3FF*32
    {RA_PROX_HIGH_DIFF_CFG_CH2_1_0x85, 0x00},
    {RA_PROX_HIGH_DIFF_CFG_CH3_0_0x86, 0xFF}, //high int 0x3FF*32
    {RA_PROX_HIGH_DIFF_CFG_CH3_1_0x87, 0x03},

    {RA_PROX_LOW_DIFF_CFG_CH0_0_0x88,  0x04}, //low int 0x2FF*32
    {RA_PROX_LOW_DIFF_CFG_CH0_1_0x89,  0x00},
    {RA_PROX_LOW_DIFF_CFG_CH1_0_0x8a,  0x04}, //low int 0x2FF*32
    {RA_PROX_LOW_DIFF_CFG_CH1_1_0x8b,  0x00},
    {RA_PROX_LOW_DIFF_CFG_CH2_0_0x8c,  0xFF}, //low int 0x2FF*32
    {RA_PROX_LOW_DIFF_CFG_CH2_1_0x8d,  0x00},
    {RA_PROX_LOW_DIFF_CFG_CH3_0_0x8e,  0xFF}, //low int 0x2FF*32
    {RA_PROX_LOW_DIFF_CFG_CH3_1_0x8f,  0x03},
    ...
    {RA_CH0_CFG_7_0_0x03,              0x0C}, //channel config
    {RA_CH0_CFG_9_8_0x04,              0x00},
    {RA_CH1_CFG_7_0_0x05,              0x32},
    {RA_CH1_CFG_9_8_0x06,              0x00},
    {RA_CH2_CFG_7_0_0x07,              0x30},
    {RA_CH2_CFG_9_8_0x08,              0x00},
    {RA_CH3_CFG_7_0_0x09,              0x00},
    {RA_CH3_CFG_9_8_0x0A,              0x00},

    //{RA_CH_NUM_CFG_0x24,              0x07}, //open channel.
};
