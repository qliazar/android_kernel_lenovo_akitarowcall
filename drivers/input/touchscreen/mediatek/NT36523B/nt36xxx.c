 ...
 *
 * $Revision: 85553 $
 * $Date: 2021-07-22 15:15:21 +0800 (週四, 22 七月 2021) $
 *
...
//struct nvt_ts_data ts_nt35523b;
...
void hardwareinfont_set(void)
{
   ...
   // char vendor_for_id[HARDWARE_MAX_ITEM_LONGTH];
    ...
    {
        snprintf(ic_name,HARDWARE_MAX_ITEM_LONGTH,"FT8201");
    }else{
        snprintf(ic_name,HARDWARE_MAX_ITEM_LONGTH,"Other IC");
    }
#endif
    snprintf(ic_name,HARDWARE_MAX_ITEM_LONGTH,"nt35523b");
    //snprintf(firmware_ver,HARDWARE_MAX_ITEM_LONGTH,"%s,%s,FW:0x%x","INX","nt35523b","0x50");
	snprintf(firmware_ver,HARDWARE_MAX_ITEM_LONGTH,"%s,%s,FW:0x%x","INX","NT35523B",ts->fw_ver);
    NVT_LOG("firmware_ver=%s\n", firmware_ver);
...
static void nvt_esd_check_func(struct work_struct *work)
{
	...
	//hardwareinfont_set();//type,liutongxing.wt,add,20190523,tp update fw display hardwareinfo.
...
//	ts_nt35523b->client = client;
	...
	NVT_LOG("request irq  ts->irq_gpio %d begain\n", ts->irq_gpio);
