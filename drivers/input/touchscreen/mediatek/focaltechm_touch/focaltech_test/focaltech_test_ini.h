...
#define get_value_interface(name, value) \
    getm_keyword_value("Interface", name, value)
#define get_value_basic(name, value) \
    getm_keyword_value("Basic_Threshold", name, value)
#define get_value_detail(name, value) \
    getm_keyword_value("SpecialSet", name, value)
#define get_value_testitem(name, value) \
    getm_keyword_value("TestItem", name, value)
#endif /* _INI_H */
